...
|----------------------|---------------------------------------------------------|----------------|
| `San`                | REST API using Spring Boot, JPA, and MySQL              | ✅ Completed    |
| `TaskManager`        | CRUD-based task manager app                             | ✅ Completed    |
| `UserAuthJWT`        | Spring Security + JWT based user authentication system  | 🛠 In Progress  |
...
│
├── San/                 → Spring Boot product service
├── TaskManager/         → Simple task management API
├── UserAuthJWT/         → User authentication with JWT
├── ...                  → Future Spring Boot projects
└── README.md            → Common documentation for all projects
```
...
**Santhosh Jeevan**  
📧 Email: [santhoshjeevan2468s@gmail.com](mailto:santhoshjeevan2468s@gmail.com)  
💻 GitHub: [Santhosh23s](https://github.com/Santhosh23s)
